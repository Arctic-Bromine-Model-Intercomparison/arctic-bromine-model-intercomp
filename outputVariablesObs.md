...
Spatial and temporal resolution should be as high as possible. Hourly output would be perfect. Daily files are preferred, but hourly or monthly files are also okay.
